                ...
                <div class="row">
                    ...
                    <div class="inn">
                        <ul>
                            <li>
                                <div class="tline-inn">
                                    <div class="tline-im animate animate__animated animate__slower animate__fadeInUp anistart"
                                        data-ani="animate__fadeInUp">
                                        <img src="../../assets/images/icon/rings.png" alt="" loading="lazy">
                                    </div>
                                    <div class="tline-con animate animate__animated animate__slow animate__fadeInUp anistart"
                                        data-ani="animate__fadeInUp">
                                        <h5>Register</h5>
                            ...
                            <li>
                                <div class="tline-inn tline-inn-reve">
                                    <div class="tline-con animate animate__animated animate__slower animate__fadeInUp anistart"
                                        data-ani="animate__fadeInUp">
                                    ...
                                    <div class="tline-im animate animate__animated animate__slow animate__fadeInUp anistart"
                                        data-ani="animate__fadeInUp">
